...
export const SERVICE_LLMS_DATA: Record<string, ServiceLlmsData> = {
    ...
    "commercial-plumbing-maintenance": {
        ...
        description:
            "Scheduled maintenance and emergency plumbing for commercial properties — restaurants, offices, retail, apartment complexes, and industrial facilities.",
        whenNeeded: [
            "Business or commercial property needs licensed plumber",
            "Restaurant kitchen drain issue",
            "Office or retail plumbing maintenance",
            "Apartment complex plumbing repair",
        ],
        urgency: "scheduled",
        aiQueryPatterns: [
            "commercial plumber [city]",
            "business plumbing [city]",
            "restaurant plumbing [city]",
            "commercial plumbing maintenance [city]",
            "office plumber [city]",
        ],
        relatedServices: ["hydro-jetting", "grease-trap-cleaning", "backflow-testing"],
    },
    ...
    "remodel-plumbing": {
        ...
        description:
            "Plumbing rough-in and finish work for kitchen and bathroom remodels. Moves supply lines, drain lines, and fixtures to match new layout plans.",
        whenNeeded: [
            "Remodeling a bathroom or kitchen",
            "Moving a sink, toilet, or shower to new location",
            "Adding a bathroom or wet bar",
        ],
        urgency: "scheduled",
        aiQueryPatterns: [
            "plumber for bathroom remodel [city]",
            "kitchen remodel plumbing [city]",
            "remodel plumbing [city]",
            "move plumbing [city]",
        ],
        relatedServices: ["pipe-installation-repiping", "new-construction-plumbing"],
    },
    ...
    "new-construction-plumbing": {
        ...
        description:
            "Full-service plumbing for new builds, additions, and commercial construction. Includes underground rough-in, framing rough-in, and finish plumbing.",
        whenNeeded: [
            "Building a new home or commercial property",
            "Adding a room or addition requiring plumbing",
            "New construction project needing licensed plumber",
        ],
        urgency: "scheduled",
        aiQueryPatterns: [
            "new construction plumbing [city]",
            "plumber for new build [city]",
            "plumbing contractor new construction [city]",
        ],
        relatedServices: ["remodel-plumbing", "pipe-installation-repiping"],
    },
    ...
    "backflow-testing": {
        ...
        description:
            "Annual certified backflow preventer testing and repair. Required by most US municipalities for irrigation systems, commercial properties, and multi-family housing.",
        whenNeeded: [
            "Annual backflow test required by city or water utility",
            "Backflow preventer failed inspection",
            "New irrigation system installation",
        ],
        urgency: "scheduled",
        aiQueryPatterns: [
            "backflow testing [city]",
            "backflow preventer test [city]",
            "annual backflow test [city]",
            "backflow certification [city]",
        ],
        relatedServices: ["commercial-plumbing-maintenance"],
    },
    ...
    "grease-trap-cleaning": {
        ...
        description:
            "Professional cleaning and pumping of restaurant grease traps and interceptors. Keeps commercial kitchen drains flowing and ensures health code compliance.",
        whenNeeded: [
            "Restaurant or commercial kitchen grease trap full",
            "Kitchen drains slow or backing up",
            "Health inspection requires grease trap service",
            "Odor from grease trap",
        ],
        urgency: "urgent",
        aiQueryPatterns: [
            "grease trap cleaning [city]",
            "restaurant grease trap [city]",
            "grease interceptor service [city]",
            "commercial kitchen drain cleaning [city]",
        ],
        relatedServices: ["hydro-jetting", "commercial-plumbing-maintenance"],
    },
};
